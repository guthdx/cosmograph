...
pytest tests/test_patterns.py -v --tb=short
  ...
  <done>
All pattern tests pass, covering validation, loading, error handling, and GenericExtractor integration. Test file contains 6 test classes with comprehensive coverage of all validation scenarios.
  </done>
</task>
...
<success_criteria>
- test_patterns.py exists with 6 test classes covering: EntityPattern, RelationshipTrigger, PatternConfig, load_patterns, load_default_patterns, GenericExtractor integration
- All tests pass
